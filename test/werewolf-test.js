...
describe('Werewolf', function() {
  ...
  it('should start off not hungry', function() {
    // your code here
    var werewolf = new Werewolf('Kirk', 'Denver');
  ...
  it('should become hungry after changing into werewolf form', function() {
    // your code here
    var werewolf = new Werewolf('Kate', 'San Jose');
    assert.equal(werewolf.hungry, false);
    werewolf.change();
  ...
  it('should be able to eat(victim) once hungry', function() {
    var werewolf = new Werewolf('Jane', 'San Francisco')
    var victim = new Victim('Luke')
  ...
  it('should not be hungry after changing back to human form', function() {
    // your code here
    var werewolf = new Werewolf('Annie', 'Mojave Desert')
    var victim = new Victim('Jacob')
    werewolf.change();
    werewolf.change();
    assert.equal(werewolf.hungry, false)
  });
  ...
  it('should change back to human form after eating', function() {
    var werewolf = new Werewolf('Zoe', 'Richmond, VT')
    var victim = new Victim('Victor')
    werewolf.change();
    werewolf.eat(victim);
    assert.equal(werewolf.human, true)
  ...
  it('should not be able to consume victim in human form', function() {
    // your code here
    var werewolf = new Werewolf('Quinne', 'Philly');
    var victim = new Victim('Tess')
